...
import WavePorComponent from './WavePorComponent';
import WaveInnComponent from './WaveInnComponent';
    ...
    <footer id="portfolio">
      <div className="left">
        <div className={`text_box${state.isAnimation ? ' ani' : ''}`}>
          ...
          <div className="p_box">
            <p className="subTitle"> - 뽀로로몰(개인프로젝트)</p>
            <p className="subTitle"> - 이니스프리(팀프로젝트)</p>
          </div>
        </div>
      </div>
